...
<span>iAM</span><span>iam</span> Scruffy’s Pizza operates nationwide
with 20 stores. Scruffy’s primarily operates as a take-out and delivery
pizza service, although it has some in-store restaurants in motorway
plazas and some small supermarkets.
...
-   Scruffy’s wishes install a flat screen advertising display in each
...
-   Scruffy’s POS system is based around a FreeBSD UNIX server in
